  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        <button type='submit' className='bg-primary text-white w-full py-2.5 rounded-lg text-base font-semibold transition-all duration-300 ease-in-out hover:bg-primary/90 hover:scale-[1.02] active:scale-95
          shadow-md hover:shadow-lg'>{state === 'Sign Up' ? "Create Account" : "Login"}</button>
        {
          state === "Sign Up"
